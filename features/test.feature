...
Сценарий: Проверка создания номенклатуры в ERP
	...
	И я активизирую поле "Вид номенклатуры"
	И в поле 'Вид номенклатуры' я ввожу текст 'Изделия из дерева'
	И я нажимаю на кнопку 'Записать и закрыть'
	И я жду закрытия окна 'Номенклатура (создание) *' в течение 21 секунд
