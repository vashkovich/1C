...
Функция СоздатьСервернуюБазу1С()
    ...
    Лог.Информация("ПараметрыБазы1С: " + Строка(ПараметрыБазы1С));
    Лог.Информация("ПараметрыСУБД:" + Строка(ПараметрыСУБД));
    Лог.Информация("АвторизацияВКластере:" + Строка(АвторизацияВКластере));
