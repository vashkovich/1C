...
Функция СоздатьСервернуюБазу1С()
    ...
    Лог.Информация("ПараметрыБазы1С: " + СтруктураВСтроку(ПараметрыБазы1С));
    Лог.Информация("ПараметрыСУБД:" + СтруктураВСтроку(ПараметрыСУБД));
    Лог.Информация("АвторизацияВКластере:" + СтруктураВСтроку(АвторизацияВКластере));
    Лог.Информация("ПУТЬ_К_ФАЙЛУ_БАЗЫ:" + СтруктураВСтроку(ПУТЬ_К_ФАЙЛУ_БАЗЫ));
